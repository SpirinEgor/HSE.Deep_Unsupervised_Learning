...
def q2_save_results(fn):
    ...
    save_training_plot(train_losses, test_losses, f"Q2 Train Plot", f"results/q2_train_plot.png")
...
def b3_save_results(fn):
    ...
    save_training_plot(train_losses, test_losses, f"B3 Train Plot", f"results/q2_train_plot.png")
