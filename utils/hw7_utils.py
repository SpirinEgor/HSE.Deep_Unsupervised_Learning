...
def q2_save_results(fn):
    ...
    plot_q2_supervised(
        pretrained_losses, random_losses, "Linear classification losses", "results/q2_supervised_losses.png"
    )
...
def b5_save_results(fn):
    ...
    show_samples(mnist_reconstructions * 255.0, nrow=20, fname="figures/b5_mnist.png", title=f"Source domain: MNIST")
    show_samples(
        colored_mnist_reconstructions * 255.0,
        nrow=20,
